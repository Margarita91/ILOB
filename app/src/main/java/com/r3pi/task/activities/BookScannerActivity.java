...
public class BookScannerActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void onCreate(Bundle state) {
        ...
        if (isPermGranted(Manifest.permission.CAMERA)) {
            ...
            checkPermission(mPermDeniedList, Constants.PERM_REQUEST_CAMERA);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode ==  Constants.PERM_REQUEST_CAMERA) {
    ...
    public void handleResult(Result rawResult) {
        ...
        result.putExtra(Constants.BAR_CODE,rawResult.getText() );
        this.setResult(Constants.RC_BARCODE_CAPTURE,result);
        finish();
    }
}